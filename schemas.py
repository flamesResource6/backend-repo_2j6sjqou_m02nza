...
class Reservation(BaseModel):
    ...
    time: str = Field(..., description="Reservation time in HH:MM format (24h)")
    party_size: int = Field(..., ge=1, le=20, description="Number of guests")
    occasion: Optional[str] = Field(None, description="Optional occasion like birthday/anniversary")
